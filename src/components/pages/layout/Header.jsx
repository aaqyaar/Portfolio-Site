...
export default function Example() {
  return (
    <Disclosure
      as="nav"
      className="bg-gray-800 z-10 fixed top-0 shadow-md left-0 right-0"
    >
      {({ open }) => (
        <>
              ...
              <section className="w-full">
                <div className="flex justify-between items-center">
                  <div className="mx-4">
                    <a
                      href="/#"
                      className="text-2xl text-white font-bold font-poppins"
                    >
                      Abdi Zamed
                    </a>
                  </div>
                  <div className="hidden sm:block font-poppins">
          ...
          <Disclosure.Panel className="sm:hidden font-poppins">
